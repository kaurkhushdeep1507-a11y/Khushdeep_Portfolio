  ...
  const interests = [
    ...
    <section id="credentials" className="py-24 bg-stone-50 relative border-b border-stone-200">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        {/* Section Heading */}
        <div className="mb-16">
          <span className="text-stone-500 text-xs font-mono uppercase tracking-widest block mb-2">// EXPERIENCE & BACKGROUND</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-7 flex flex-col gap-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-8 pb-3 border-b border-stone-200">
                ...
                <h3 className="font-mono text-xs uppercase tracking-[0.15em] text-stone-900 font-bold">EXPERIENCE</h3>
              </div>
            ...
            <div>
              <div className="flex items-center gap-3 mb-8 pb-3 border-b border-stone-200">
                ...
                <h3 className="font-mono text-xs uppercase tracking-[0.15em] text-stone-900 font-bold">EDUCATION</h3>
              </div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            ...
            <div className="p-8 bg-stone-900 text-white rounded-2xl flex flex-col gap-4 shadow-md relative overflow-hidden">
              ...
              <p className="text-[8px] font-mono uppercase tracking-[0.2em] text-stone-400">A LITTLE ABOUT MY APPROACH</p>
              <h4 className="font-serif text-xl font-bold tracking-tight text-white mb-1">
                How I Approach Design
              </h4>
             <h5 className="text-white text-xs font-light leading-relaxed">
              I enjoy turning ideas into simple, thoughtful visuals that feel right for the brand and the people it speaks to. I focus on strong composition, typography, colour, and details that make a design feel complete.
            </h5>
            </div>

            {/* Core Competencies chips */}
            <div className="p-8 bg-white border border-stone-200 rounded-2xl shadow-sm">
              <span className="text-[8px] font-mono uppercase tracking-[0.2em] text-stone-500 block mb-4 font-bold">// THINGS I BRING TO A PROJECT</span>
            ...
            <div className="p-7 bg-white border border-stone-200 rounded-2xl shadow-sm">
              <span className="text-[8px] font-mono uppercase tracking-[0.2em] text-stone-500 block mb-3 font-bold">
              // CURRENTLY OPEN TO
              </span>
              ...
              <p className="text-stone-600 text-xs font-light leading-relaxed">
                Available for branding, social media, packaging, print, and other
